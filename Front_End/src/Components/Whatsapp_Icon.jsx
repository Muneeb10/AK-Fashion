...
const WhatsAppIcon = () => {
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <a
        href={`https://wa.me/923461709871`} // Replace with your number
        target="_blank"
      ...
      >
        ...
        <span className="animate-ping absolute -z-10 inline-flex h-full w-full rounded-full bg-teal-400 opacity-75 group-hover:opacity-100"></span>
      </a>
    </div>
  );
};
